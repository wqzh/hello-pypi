-- 001_initial.sql — pi-storage-sqlite 初始 schema
-- 对应上游 packages/storage/sqlite-node/src/sqlite/migrations/001_initial.sql
-- 必须 1:1 还原（表结构、WITHOUT ROWID、索引）。
